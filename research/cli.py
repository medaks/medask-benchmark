...
def main():
    ...
    p_run.add_argument("--temp", type=float, default=0.6, help="Temperature (default: 0.6)")
    p_run.add_argument("--top-p", type=float, help="Top-p sampling")
    p_run.add_argument("--top-k", type=int, help="Top-k sampling")
    p_run.add_argument("--max-tokens", type=int, default=2048, help="Max tokens (default: 2048)")
